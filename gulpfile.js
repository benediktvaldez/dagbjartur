...
gulp.cfg.silent = gulp.plugin.util.env.hasOwnProperty('silent');
gulp.cfg.debug = gulp.cfg.silent ? false : gulp.plugin.util.env.hasOwnProperty('debug');
gulp.cfg.verbose = gulp.cfg.silent ? false : gulp.plugin.util.env.hasOwnProperty('verbose');
